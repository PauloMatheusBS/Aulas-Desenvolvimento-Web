...
def conectar_banco():
    try:
        conexao = mysql.connector.connect(
            host='10.28.2.59',       # Substitua com o endereço do seu servidor MySQL se não estiver rodando localmente
            user='suporte',     # Substitua com o nome de usuário do MySQL
            password='suporte',   # Substitua com a senha do MySQL
